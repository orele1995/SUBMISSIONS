...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/17f7f965f515e7085e085b42f7137c06f50f70e9/angularjs/angular.d.ts
...
declare namespace angular {
    ...
    interface IModule {
         ...
         *
         * @param name Title of the directive in camel-case (i.e. ngBind which will match as ng-bind)
    ...
    interface IFilterService {
         ...
         * $filter(name);
         *
         * @param name Title of the filter function to retrieve
         */
        <T>(name: string): T;
    }
    ...
    interface ICacheFactoryService {
         ...
         * Factory that constructs Cache objects and gives access to them.
         *
         * @param cacheId Title or id of the newly created cache.
         ...
         *
         * @param cacheId Title or id of a cache to access.
         */
    ...
    */
    interface IHttpProviderDefaults {
        ...
        /** Title of HTTP header to populate with the XSRF token. */
        xsrfHeaderName?: string;

        /** Title of cookie containing the XSRF token. */
